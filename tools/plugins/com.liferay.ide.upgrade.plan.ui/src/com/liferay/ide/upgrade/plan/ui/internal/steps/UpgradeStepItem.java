 ...
 */
public class UpgradeStepItem implements IExpansionListener, UpgradeItem, UpgradeListener {
	...
	public UpgradeStepItem(FormToolkit formToolkit, ScrolledForm scrolledForm, UpgradeStep upgradeStep) {
		...
		_updateEnablement(upgradeStep, _enables);
	}
	...
	public void expansionStateChanged(ExpansionEvent expansionEvent) {
		ISelection selection = new StructuredSelection(_upgradeStep);
	...
	private IStatus _skip(IProgressMonitor progressMonitor) {
		_upgradeStep.setStatus(UpgradeStepStatus.SKIPPED);
